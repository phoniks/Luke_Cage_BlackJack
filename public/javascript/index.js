...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dealer = function (_Player) {
	  _inherits(Dealer, _Player);

	  function Dealer(options) {
	    _classCallCheck(this, Dealer);

	    var _this = _possibleConstructorReturn(this, (Dealer.__proto__ || Object.getPrototypeOf(Dealer)).call(this, options));
	...
	var Deck = function () {
	  ...
	  _createClass(Deck, [{
	    ...
	    value: function createDeck() {
	      return this.shuffle(SUITS.reduce(function (memo, suit) {
	        return memo.concat(RANKS.map(function (rank) {
	          return new _card2.default(suit, rank);
	        }));
	      }, []));
	      //
	      // return this.shuffle( )
